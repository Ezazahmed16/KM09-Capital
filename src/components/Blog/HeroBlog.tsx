...
const HeroBlog = () => {
  return (
    <section
      className="relative min-h-[45vh] md:min-h-[52vh] flex flex-col justify-center bg-[#071322] bg-none md:bg-[url('/AboutBanner.png')] md:bg-cover md:bg-center md:bg-no-repeat overflow-hidden pt-32 pb-14 md:pb-20 border-b border-slate-200/50 dark:border-slate-800/80 transition-colors duration-300"
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center flex flex-col items-center">
        ...
        >
          আমাদের ব্লগ ও বিষয়ভিত্তিক নিবন্ধ
        </h1>

        {/* Subtitle */}
        <p className="text-slate-300 text-sm sm:text-base md:text-lg max-w-2xl font-medium leading-relaxed mb-8">
          সমবায় ব্যবস্থাপনা, স্মার্ট সঞ্চয় কৌশল, যৌথ বিনিয়োগ ও দীর্ঘমেয়াদী আর্থিক নিরাপত্তায় অভিজ্ঞ সদস্যদের লেখা বিষয়ভিত্তিক নিবন্ধসমূহ।
        </p>
