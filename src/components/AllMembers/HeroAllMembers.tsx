...
const HeroAllMembers = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/4 w-[350px] h-[250px] bg-[#0b1e33] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute top-1/2 right-10 w-[300px] h-[200px] bg-[#BA9853]/10 rounded-full blur-[120px] pointer-events-none" />
